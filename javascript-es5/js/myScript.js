...
console.log(xArray1.toString());
xArray1.shift(); //Remove first item.
console.log(xArray1.toString());*/
...
//Using map
//Go through each array item and execute the function sent by each item.
...
//Using filter
//Return a new array with items that passed the condition.
...
//Delect object function
delete myObject.isAdult;
console.log(myObject.isAdult());*/
...
function Worker(first, last, age, eye, profession) {
    ...
    Person.apply(this, [first, last, age, eye]);
...
/*function catchEvent(ev) {
    //Element this points to current div element.
...
/*
Note:
- "use strict"; - in other word strict mode, and it helps us detect syntasis errors
